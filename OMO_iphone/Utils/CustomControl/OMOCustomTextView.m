...
@implementation OMOCustomTextView
...
- (void)viewdidload{
    ...
    _placehLab = [[UILabel alloc] initWithFrame:CGRectMake(10, 7, self.frame.size.width-10, 0)];
...
- (void)setTextLength:(NSInteger)textLength{
    ...
    self.contentInset = UIEdgeInsetsMake(self.contentInset.top, self.contentInset.left, CGRectGetHeight(_promptLab.frame)+_promptFrameMaxY, self.contentInset.right);
}
