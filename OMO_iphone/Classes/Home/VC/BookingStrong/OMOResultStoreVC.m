...
@implementation OMOResultStoreVC
...
- (UIButton *)consultingBtn{
    ...
    if(_consultingBtn == nil){
        ...
        [_consultingBtn setImage:[UIImage imageNamed:@"Booking_Store"] forState:UIControlStateNormal];
        [_consultingBtn setTitle:@"预约门店" forState:UIControlStateNormal];
        ...
        [_consultingBtn addTarget:self action:@selector(omo_bookingStrong) forControlEvents:UIControlEventTouchUpInside];
...
#pragma mark ------- 咨询医生 ----------
- (void)omo_bookingStrong{
    
    OMOStoreListVC *storeListVC = [[OMOStoreListVC alloc]init];
