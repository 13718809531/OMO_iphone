...
@implementation OMOBookingStoreView
...
- (UIButton *)bookingBtn{
    ...
    if(_bookingBtn == nil){
        ...
        [_bookingBtn setImage:[UIImage imageNamed:@"Booking_Store"] forState:UIControlStateNormal];
        [_bookingBtn setTitle:@"预约门店" forState:UIControlStateNormal];
...
- (void)omo_remoteBooking{
    ...
    OMOResultStoreVC *bookingStoreVC = [[OMOResultStoreVC alloc]init];
    [[OMOIphoneManager getCurrentVC].navigationController pushViewController:bookingStoreVC animated:YES];
}
