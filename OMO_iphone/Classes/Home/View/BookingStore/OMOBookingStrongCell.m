...
#import "OMOBookingStrongCell.h"

@interface OMOBookingStrongCell()<UITextFieldDelegate>
...
@implementation OMOBookingStroreCell
...
- (void)setDict:(NSDictionary *)dict{
    ...
    if([type isEqualToString:@"1"]){
        ...
        _arrowImg.image = [UIImage imageNamed:@"App_Back"];
        _arrowImg.hidden = NO;
    }else{
