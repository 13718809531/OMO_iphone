...
- (void)viewDidLoad {
    ...
    [self.bar addTitltLabelWithText:@"关于我们" Font:navTitleFont];
...
- (UILabel *)textView{
    ...
    if(_textView == nil){
        ...
        _textView.lwb_height = [_textView getLabelHightOfLineSpacing:4.f Kern:1.f];
    }
    return _textView;
}
