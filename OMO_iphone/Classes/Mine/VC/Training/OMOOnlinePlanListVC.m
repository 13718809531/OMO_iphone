...
@implementation OMOOnlinePlanListVC
...
- (OMONoAssessmentDataView *)noDataView{
    ...
    if(_noDataView == nil){
        ...
        _noDataView = [[OMONoAssessmentDataView alloc]initWithFrame:CGRectMake(lwb_margin * 2, 0, SCREENW - lwb_margin * 4, IFFitFloat6(300))];
    }
    return _noDataView;
}
- (UIButton *)startBtn{
