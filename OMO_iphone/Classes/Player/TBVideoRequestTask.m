...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _tempPath = [cachesPath stringByAppendingPathComponent:@"temp.mp4"];
        ...
        if ([fileManager fileExistsAtPath:_tempPath]) {
            ...
            isCreat = [fileManager createFileAtPath:_tempPath contents:nil attributes:nil];
        } else {
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection{
    ...
    if (_taskArr.count > 2) {
        ...
        if(isCreat){
            ...
            NSString *lastPath = [[connection.currentRequest.URL absoluteString] componentsSeparatedByString:@"/"].lastObject;
            ...
            if (![fileManager fileExistsAtPath:copyPath]) {
                ...
                dispatch_async(dispatch_get_global_queue(0, 0), ^{
                    ...
                    [fileManager copyItemAtPath:weakSelf.tempPath toPath:copyPath error:&newError];
