...
@implementation OMOAllPaySuccessVC
...
- (void)omo_requestData{
    ...
    [[OMONetworkManager  sharedData]postWithURLString:@"60002" parameters:@{@"pe_order_id":_kangFuBaoModel.pe_order_id} success:^(id responseObject) {
