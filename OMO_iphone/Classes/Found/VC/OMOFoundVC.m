...
@interface OMOFoundVC ()
<SDCycleScrollViewDelegate,
UICollectionViewDataSource,
UICollectionViewDelegate,
UICollectionViewDelegateFlowLayout>

@property(weak,nonatomic)SDCycleScrollView *scrollView;
/**  */
...
- (void)setScrollView{
    ...
    SDCycleScrollView *scrollView = [[SDCycleScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREENW, IFFitFloat6(200))];
    scrollView.pageDotColor = mainBackColor;
    ...
    scrollView.placeholderImage = [UIImage imageNamed:@""];
