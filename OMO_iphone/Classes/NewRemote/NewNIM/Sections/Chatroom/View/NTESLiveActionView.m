...
- (NTESChatroomSegmentedControl *)segmentedControl{
    if (!_segmentedControl) {
        ...
        for (NSInteger index = 0; index < self.segmentedItems.count; index++) {
            ...
            [_segmentedControl setTitleColor:[UIColor colorWithHexString:@"0x333333"] forState:UIControlStateNormal atIndex:index];
            [_segmentedControl setTitleColor:[UIColor colorWithHexString:@"0x238efa"] forState:UIControlStateSelected atIndex:index];
