...
- (void)viewDidLoad{
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithHexString:@"#edf1f5"];
...
- (NSArray<UITableViewRowAction *> *)tableView:(UITableView *)tableView editActionsForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    appointManager.backgroundColor = [UIColor colorWithHexString:@"0x0BB3FC"];
    ...
    kickMember.backgroundColor = [UIColor colorWithHexString:@"0xC71585"];
