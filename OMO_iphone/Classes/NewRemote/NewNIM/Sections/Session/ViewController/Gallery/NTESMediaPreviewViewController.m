...
- (void)viewDidLoad {
    ...
    self.collectionView.backgroundColor = [UIColor colorWithHexString:@"0x1d1d1d"];
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _durationLabel.textColor = [UIColor colorWithHexString:@"0xffffff"];
        _durationLabel.shadowColor = [UIColor blackColor];
