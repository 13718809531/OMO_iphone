...
//    [self updateButton];
    ...
    self.view.backgroundColor = [UIColor colorWithHexString:@"0xE9ECF0"];
    
    [_nameTextLabel setTextColor:[UIColor colorWithHexString:@"0x868686"]];
    [_hintTextLabel setTextColor:[UIColor colorWithHexString:@"0x868686"]];
    
    [_cancelRequestButton setBackgroundColor:[UIColor colorWithHexString:@"0xF54A63"]];
    [_rejectButton setBackgroundColor:[UIColor colorWithHexString:@"0xF54A63"]];
    [_acceptButton setBackgroundColor:[UIColor colorWithHexString:@"0x0F91F2"]];
    [_cancelButton setBackgroundColor:[UIColor colorWithHexString:@"0x0F91F2"]];
    [_clearButton setBackgroundColor:[UIColor colorWithHexString:@"0xF54A63"]];
    [_headerView setBackgroundColor:[UIColor colorWithHexString:@"0xFDFDFE"]];
    ...
    _headerView.layer.borderColor = [UIColor colorWithHexString:@"0x9FA1A5"].CGColor;
    _footerView.layer.borderWidth = 0.5;
    _footerView.layer.borderColor = [UIColor colorWithHexString:@"0x9FA1A5"].CGColor;
