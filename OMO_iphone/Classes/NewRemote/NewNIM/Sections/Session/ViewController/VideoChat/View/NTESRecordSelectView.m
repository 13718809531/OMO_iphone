...
#define NTESRecordSelectLabelTextColor @"#333333"
#define NTESRecordSelectLabelTextGrayColor @"#999999"
#define NTESRecordSelectStartButtonGrayColor @"d0d0d0"
...
-(instancetype)initWithFrame:(CGRect)frame Video:(BOOL)isVideo
{
    if (self = [super initWithFrame:frame]) {
        ...
        _title.textColor = [UIColor colorWithHexString:NTESRecordSelectLabelTextColor];
        ...
        _subTitle.textColor = [UIColor colorWithHexString:NTESRecordSelectLabelTextGrayColor];
        ...
        _audioConversationLable.textColor = [UIColor colorWithHexString:NTESRecordSelectLabelTextColor];
        ...
        _myMediaLable.textColor = [UIColor colorWithHexString:NTESRecordSelectLabelTextColor];
        ...
        _otherSideMediaLable.textColor = [UIColor colorWithHexString:NTESRecordSelectLabelTextColor];
        ...
        [_cancelButton setTitleColor:[UIColor colorWithHexString:NTESRecordSelectLabelTextColor] forState:UIControlStateNormal];
        [_cancelButton addTarget:self action:@selector(cancelButtonPressed) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:_cancelButton];
        
        _startButton = [[UIButton alloc]init];
        [_startButton setTitle:@"开始录制" forState:UIControlStateNormal];
        [_startButton setTitleColor:[UIColor colorWithHexString:NTESRecordSelectLabelTextColor] forState:UIControlStateNormal];
        [_startButton setTitleColor:[UIColor colorWithHexString:NTESRecordSelectStartButtonGrayColor] forState:UIControlStateDisabled];
