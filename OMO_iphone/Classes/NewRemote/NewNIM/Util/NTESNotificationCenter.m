...
//    else {
        ...
        if (currentVC.navigationController.presentedViewController) {
            // fix bug MMC-1431
            [currentVC.navigationController.presentedViewController dismissViewControllerAnimated:NO completion:nil];
        }
    if ([currentVC isKindOfClass:[OMOTabBarController class]]) {
//        (OMOTabBarController)currentVC.tabBar.hidden = YES;
    }
