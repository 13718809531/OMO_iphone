...
- (void)setupNav
{
    ...
    [registerBtn setTitleColor:[UIColor colorWithHexString:@"0x2294ff"] forState:UIControlStateNormal];
    ...
    [self.navigationController.navigationBar setTintColor:[UIColor colorWithHexString:@"0xffffff"]];
...
- (void)resetTextField:(UITextField *)textField{
    ...
    [textField setValue:RGBA(152, 152, 152, 0.6) forKeyPath:@"_placeholderLabel.textColor"];
    textField.tintColor = [UIColor whiteColor];
